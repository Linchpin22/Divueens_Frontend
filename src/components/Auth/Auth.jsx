...
export default function Auth({ show, changeView }) {
  ...
  return (
    <div className={`w-[100vw] h-[100vh] bg-black bg-opacity-50 overflow-hidden fixed top-0 z-50 ${show ? '' : 'hidden'}`}>
      <div className="w-[25em] h-fit absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] overflow-hidden max-w-[390px] bg-[#fff] p-[30px] rounded-[15px] [box-shadow:0px_15px_20px_rgba(0,0,0,0.1)]">
