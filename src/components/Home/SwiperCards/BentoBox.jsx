        ...
        <>
            ...
            <div className="flex flex-col w-full h-full">
                <div className="flex flex-col-reverse md:flex-row items-center gap-4 px-8 py-4">
                    <div className="w-full h-52 md:w-1/2 lg:w-[70%] md:h-96 border rounded-xl">
                        <Swiper
                            slidesPerView={3}
                            spaceBetween={20}
                            mousewheel={true}
                    ...
                    <div className="w-full h-52 lg:w-[30%] md:h-96 border rounded-xl flex flex-col items-center justify-center text-center">
