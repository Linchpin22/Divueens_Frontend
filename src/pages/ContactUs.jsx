  ...
  return (
    ...
    <div className="flex flex-col-reverse items-start md:flex lg:flex lg:flex-row-reverse  md:flex-col justify-center m-4 lg:mt-[5rem] min-h-screen py-10">
        <div className="w-full max-w-lg bg-rose-50  lg:w-[40%] p-8 md:max-w-[90%] rounded-2xl shadow-2xl mt-6 md:mt-0 sm:ml-[3rem] md:ml-10">
            ...
            <div>
                <label for="email" className="block mb-1 text-[1rem] md:mt-8 lg:text-[1.3rem] sm:text-[1.1rem] xl:text-[1.4rem] md:text-[1.3rem]">Email Address</label>
                <input
                type="email"
                id="email"
                name="email"
            ...
            <div>
                <label for="helpType" className="block md:mt-6 lg:mt-4 lg:text-[1.3rem] text-[1rem] xl:text-[1.4rem] sm:text-[1.1rem] md:text-[1.3rem] mb-1">What do you need help with?</label>
                <select
                id="helpType"
                name="helpType"
                required
            ...
            <div>
                <label for="subject" className="block mb-1  lg:mt-4 lg:text-[1.3rem] md:mt-6 text-[1rem] xl:text-[1.4rem] sm:text-[1.1rem] md:text-[1.3rem]">Subject</label>
                <input
                type="text"
                id="subject"
                name="subject"
            ...
            <div>
                <label for="description" className="block  lg:mt-4 lg:text-[1.3rem] md:mt-6 text-[1rem] xl:text-[1.4rem] sm:text-[1.1rem] md:text-[1.3rem] mb-1">Description</label>
                <textarea
                id="description"
                name="description"
                required 
        ...
        <label class="text-sm text-slate-500 md:text-[1.2rem]">{selectedFile}</label><div className="ml-3 text-2xl text-gray-700 cursor-pointer" onClick={cancel}>&times;</div></div>
