  ...
  return (
    ...
    <div className="flex flex-col-reverse items-start md:flex lg:flex lg:flex-row-reverse  md:flex-col justify-center m-4 lg:mt-[5rem] min-h-screen py-10">
        <div className="w-full max-w-lg bg-white lg:w-[40%] p-8 md:max-w-[90%] rounded-2xl shadow-2xl mt-6 md:mt-0 sm:ml-[3rem] md:ml-10">
            ...
            <div>
                <label htmlFor="email" className="block mb-1 md:mt-8 lg:text-[1.4rem] md:text-[1.5rem]">Email Address</label>
                <input
                type="email"
                id="email"
                name="email"
            ...
            <div>
                <label htmlFor="helpType" className="block md:mt-6 lg:mt-4 lg:text-[1.4rem] md:text-[1.5rem] mb-1">What do you need help with?</label>
                <select
                id="helpType"
                name="helpType"
                required
            ...
            <div>
                <label htmlFor="subject" className="block mb-1  lg:mt-4 lg:text-[1.4rem] md:mt-6 md:text-[1.5rem]">Subject</label>
                <input
                type="text"
                id="subject"
                name="subject"
            ...
            <div>
                <label htmlFor="description" className="block  lg:mt-4 lg:text-[1.4rem] md:mt-6 md:text-[1.5rem] mb-1">Description</label>
                <textarea
                id="description"
                name="description"
                required 
        ...
        <label className="text-sm text-slate-500">{selectedFile}</label><div className="ml-3 text-2xl text-gray-700 cursor-pointer" onClick={cancel}>&times;</div></div>
        ...
        <div className="w-full pt-5 md:w-sm md:mt-14 lg:w-[45%] lg:ml-0 sm:ml-6 md:ml-0 px-4 md:px-8">
            ...
            <div className="flex items-center mb-4">
                ...
                <div>
                    <span className=' text-[1rem] sm:text-[1.4rem] xl:text-[1.7rem] md:text-[1.6rem] lg:text-[1.3rem] '>Call now:</span>
                    <span className="text-rose-600 xl:text-[1.5rem]  md:text-[1.6rem] sm:text-[1.4rem] text-[1rem] ml-3 lg:text-[1.3rem]  font-semibold">+917423739126</span>
                </div>
            </div>
            <div className="flex items-center mb-4">
                <div className="text-rose-500 mr-2">
                ...
                <div>
                    <span className='sm:text-[1.4rem] xl:text-[1.7rem] lg:text-[1.3rem] text-[1rem] md:text-[1.6rem]'>Email:</span>
                    <span className="text-rose-600 ml-3 lg:text-[1.3rem]  md:text-[1.6rem] text-[1rem] sm:text-[1.4rem] xl:text-[1.6rem]  font-semibold">support@divueens.com</span>
                </div>
            </div>
        </div>
    </div>
